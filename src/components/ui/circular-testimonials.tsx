...
export const CircularTestimonials = ({
  ...
  }, [autoplay, testimonialsLength, activeIndex]); // Re-run on activeIndex change to reset timer on manual click
  ...
  function getImageStyle(index: number): React.CSSProperties {
    ...
    const maxStickUp = gap * 0.6; // Reduced stick up for smaller feel
